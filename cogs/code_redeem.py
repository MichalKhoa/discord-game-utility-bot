...
from redeem_code import update_file_if_needed, redeem_for_all
    ...
    async def redeem_code_for_all(self, interaction: discord.Interaction, giftCode: str):
        ...
        async with self.redeem_lock:
            try:
                ...
                stats = await asyncio.to_thread(redeem_for_all, giftCode.upper())
